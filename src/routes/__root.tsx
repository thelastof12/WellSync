...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "WellSync — Your health, connected." },
      {
        name: "description",
        content:
          "WellSync unifies activity, nutrition, mental well-being, sleep and habits into one intelligent health platform.",
      },
      { name: "author", content: "WellSync" },
    ...
    links: [
      ...
      { rel: "icon", href: "/wellsync-logo.png", type: "image/png" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/wellsync-logo.png" },
